  ...
  return (
    <div className="p-6 max-w-5xl mx-auto text-center">
      <div className="bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 p-6 rounded-2xl mb-6 shadow-lg">
        ...
        <p className="text-white text-lg">Watch the colorful mass bounce up and down! 🎈</p>
      </div>

      {/* Fun Control Panel */}
      <div className="bg-yellow-100 p-6 rounded-2xl mb-6 shadow-lg border-4 border-yellow-300">
        <h2 className="text-xl font-bold text-purple-600 mb-4">🎮 Control Panel 🎮</h2>
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-xl shadow-md border-2 border-orange-200">
            <label className="block font-bold text-sm text-orange-600 mb-2">📏 Amplitude (A)</label>
            <input
              type="number"
              value={xm}
          ...
          <div className="bg-white p-4 rounded-xl shadow-md border-2 border-purple-200">
            <label className="block font-bold text-sm text-purple-600 mb-2">🔄 Angular Frequency (ω)</label>
            <input
              type="number"
              value={omega}
          ...
          <div className="bg-white p-4 rounded-xl shadow-md border-2 border-cyan-200">
            <label className="block font-bold text-sm text-cyan-600 mb-2">🎯 Phase Angle (φ)</label>
            <input
              type="number"
              value={phi}
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-1 bg-white p-4 rounded-2xl shadow-lg border-4 border-blue-200">
          <Plot
            data={[
              { x: t, y: x, mode: "lines", name: "Displacement (x) 📍", line: { color: "#ff6b35", width: 3 } },
              { x: t, y: v, mode: "lines", name: "Velocity (v) 🏃", line: { color: "#8b5cf6", width: 3 } },
              { x: t, y: a, mode: "lines", name: "Acceleration (a) ⚡", line: { color: "#06b6d4", width: 3 } },
            ]}
            layout={{
              title: {
        ...
        <div className="w-80 bg-gradient-to-b from-sky-100 to-blue-200 p-6 rounded-2xl shadow-lg border-4 border-sky-300">
          <h3 className="text-lg font-bold text-blue-700 mb-4 text-center">🎪 Live Spring Show! 🎪</h3>

          <div className="relative h-80 flex justify-center items-start">
            <div className="relative">
              {/* Ceiling/Fixed Support */}
              <div className="w-20 h-6 bg-gradient-to-b from-amber-400 to-amber-600 mb-2 rounded-t-lg shadow-md" style={{ marginLeft: "-10px" }}>
                <div className="absolute top-0 left-0 w-full h-2 bg-amber-700 rounded-t-lg"></div>
                {/* Fun hatching pattern */}
                <div className="absolute top-2 left-0 w-full h-4 bg-gradient-to-r from-amber-300 to-amber-500 rounded-b-lg"
                  style={{
                    backgroundImage: "repeating-linear-gradient(45deg, transparent, transparent 3px, #d97706 3px, #d97706 6px)"
                  }}>
                </div>
              </div>
              ...
              <div className="relative flex flex-col items-center">
                <svg width="24" height={`${140 + swingY * 60}`} className="overflow-visible">
                  <defs>
              ...
              <div className="absolute right-0 top-40 flex items-center">
                ...
                <span className="ml-2 text-lg font-bold text-red-600 drop-shadow-sm">📍 x</span>
              </div>

              {/* Sparkle Effects */}
              <div className="absolute top-20 left-16 text-yellow-400 text-xl animate-pulse">✨</div>
              <div className="absolute top-32 right-8 text-pink-400 text-lg animate-bounce">⭐</div>
              <div className="absolute bottom-20 left-8 text-blue-400 text-sm animate-pulse">💫</div>
            </div>
          </div>
        </div>
      </div>
